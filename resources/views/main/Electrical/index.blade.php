...
<div class="bg-white rounded-lg shadow-md p-6 mb-6">
    <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-semibold">Electricals Management</h2>
        <form action="{{ route('electricals.index') }}" method="GET">
            <div class="relative">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <div id="editProductModal-{{ $electrical->id }}"
                    ...
                    <div class="bg-white w-full max-w-lg p-6 rounded-xl shadow-lg relative">
                        ...
                        <form action="{{ route('electricals.update', $electrical->id) }}" method="POST"
                            ...
                            <div>
                                ...
                                <input type="number" name="price" id="editPrice" value="{{ $electrical->price }}"
