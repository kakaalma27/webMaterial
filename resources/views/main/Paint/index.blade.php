...
@section('title', 'Buildin Paint & Decor')

@section('content')
<div class="flex justify-between items-center mb-6">
    <h1 class="text-2xl font-bold text-gray-800">Building Paint & Decor</h1>
...
<div class="bg-white rounded-lg shadow-md p-6 mb-6">
    <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-semibold">Paint & Decor Management</h2>
        <form action="{{ route('paints.index') }}" method="GET">
            <div class="relative">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <div id="editProductModal-{{ $paints->id }}"
                    ...
                    <div class="bg-white w-full max-w-lg p-6 rounded-xl shadow-lg relative">
                        ...
                        <form action="{{ route('paints.update', $paints->id) }}" method="POST"
                            ...
                            <div>
                                ...
                                <input type="number" name="price" id="editPrice" value="{{ $paints->price }}"
