...
<div class="bg-white rounded-lg shadow-md p-6 mb-6">
    <div class="flex justify-between items-center mb-4">
        ...
        <form action="{{ route('plumbings.index') }}" method="GET">
            <div class="relative">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <div id="editProductModal-{{ $plumbings->id }}"
                    ...
                    <div class="bg-white w-full max-w-lg p-6 rounded-xl shadow-lg relative">
                        ...
                        <form action="{{ route('plumbings.update', $plumbings->id) }}" method="POST"
                            ...
                            <div>
                                ...
                                <input type="number" name="price" id="editPrice" value="{{ $plumbings->price }}"
